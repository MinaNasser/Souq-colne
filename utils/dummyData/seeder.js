...
const insertData = async () => {
  try {
    ...
    if (seedAll || collections.includes("categories")) {
      ...
      console.log("Categories Inserted Successfully".green.inverse);
      ...
      if (fs.existsSync(path.resolve(__dirname, "./subcategories.json"))) {
        ...
        subcategories = subcategories.map((subcat) => {
          ...
          if (category) {
            console.log("subcategories Inserted Successfully".green.inverse);
    ...
    if (seedAll || collections.includes("brands")) {
      ...
      if (brands.length > 0) {
        ...
        console.log("brands Inserted Successfully".green.inverse);
